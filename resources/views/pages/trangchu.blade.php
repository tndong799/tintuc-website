...
<div class="container">
    ...
    <!--<a href=""> <img src="upload/slide/banner-ads.jpg" alt="" style="margin-left:25%" /> </a>
    <div class="space20"></div>-->
                            ...
                            <div class="col-md-8 border-right">
                                <div class="col-md-5">
                                    <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
                                        <img style="width: 185px;max-height:145px; margin-top: 25px;" class="img-responsive" src="upload/tintuc/{{$tin1['Hinh']}}">
                                </div>
